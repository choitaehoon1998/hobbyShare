...
public class AuthController {
  ...
  @PostMapping("login")
  public @ResponseBody Member  login(String email, String password) 
      throws Exception {
    Member cnt = memberService.loginCheck(email, password);
  ...
  */
  ...
  public void gGmailSend(String email) throws Exception {
    try {
      ...
      String user = "kwangyongkim88@gmail.com"; // 네이버일 경우 네이버 계정, gmail경우 gmail 계정
      String password = "GMrhkddyd0625"; // 패스워드

      Member member = memberService.getPassword(email);
