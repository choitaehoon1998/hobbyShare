...
카테고리 선택 :
 ...
 <option value=3>캐쥬얼</option>
 <option value=4>미니멀리즘</option>
 <option value=5>아메카지</option>
 <option value=6>워크웨어</option>
 </select>
 <br>
...
내용 : <textarea></textarea>
	...
	<form action="feedbackadd" method='post' enctype='multipart/form-data'
		id="my-form">
		<div
			...
			<div class="form-group">
				<label for="inputTitle"><b>제목</b></label> <input type='text'
					name='title' class="form-control" value="" id="my-title">
			</div>

			<div class="form-group">
				<label for="message"><b>내용</b></label>
				<textarea name='contents' rows="10" cols="30" class="form-control"
					id="my-contents"></textarea>
			</div>
