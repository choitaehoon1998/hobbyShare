...
<jsp:include page="../../tiles/header.jsp" />
  <div class="soccerproduct-form">
    <form class="product-form" action="add" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="title" class="txtb" name="title" />
      </div>
      <div>
	      <label for="price">상품 가격</la bel>
        <input type="text" id="price" class="txtb" name="price" />
      </div>
      <div>
        <label for="content">상품 상세</label>
        <textarea class="txtb" id="content" name="content"></textarea>
      </div>
      <div>
        <label for="product-image">대표 사진</label>
        <input type="file" name="filePath" id="product-image">
        <img id="image-section" src="" width="400px" style="display:none;">
      </div>
      ...
      <button class="product-btn">등록하기</button>
    </form>
  </div>
